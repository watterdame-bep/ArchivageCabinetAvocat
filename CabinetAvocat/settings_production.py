...
# Configuration des fichiers statiques - SIMPLE WhiteNoise approach
STATIC_URL = '/static/'
STATIC_ROOT = BASE_DIR / 'staticfiles'

# CRITIQUE: En production Railway, STATICFILES_DIRS doit inclure le dossier static
STATICFILES_DIRS = [
    BASE_DIR / 'static',
]
...
# WhiteNoise Middleware - Position critique après SecurityMiddleware
MIDDLEWARE.insert(1, 'whitenoise.middleware.WhiteNoiseMiddleware')

# Configuration WhiteNoise simple et efficace
