...
def dashboard_admin(request):
    ...
    nb_dossiers_agent_gagner = AvocatDossier.objects.filter(avocat=request.user.agent, dossier__score='gagne').count()
    nb_dossiers_agent_perdu = AvocatDossier.objects.filter(avocat=request.user.agent, dossier__score='perdu').count()
